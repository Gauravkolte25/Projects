...
•	Automated Cooling System design for formula student Battery pack and motor controller. Enabling better use of cooling system and increasing efficiency of cooling system by 50%. Using thermistors for temperature sensing and Mosfet’s as a switch and amplifier. The real time input from the thermistor was used to control the power of the cooling pump.
